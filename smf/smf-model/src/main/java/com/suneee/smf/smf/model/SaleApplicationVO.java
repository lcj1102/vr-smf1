...
/**
 * 
 * @Description: TODO 发货（销售）申请VO
 * @author: 崔亚强
 * @date: 2017年12月1日 下午4:49:25
 */
public class SaleApplicationVO{
	 ...
	 * 对应的子单
	 */
	private List<SaleApplicationItemVO> itemList;
	...
	public List<SaleApplicationItemVO> getItemList() {
		return itemList;
	}



	public void setItemList(List<SaleApplicationItemVO> itemList) {
